...
<div class="overflow-x-auto overflow-y-auto max-h-96 text-center" role="table">
    <div class="grid grid-cols-5 gap-4 bg-gray-700 dark:bg-gray-900 p-4 font-medium text-white uppercase cursor-pointer"
         role="row">
        ...
        <div on:click={() => sortTable('mostChampion')} on:keypress role="columnheader" tabindex="0">모스트 챔피언</div>
